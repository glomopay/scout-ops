...
// DevOps team web-server alerts for prod environment
local alertGroups = [
{
  name: 'per5MinuteEval',
  interval: 300,
  alertRules: [
  {
    title: "Web Server High Response Time - Prod",
    labels: { severity: "warning", team: "devops" },
    evaluator: { type: "gt", params: [500] },
    annotations: {
      summary: "Web server response time is high in prod environment",
